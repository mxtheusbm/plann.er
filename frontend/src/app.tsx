      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className="space-y-4">
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            {isGuestsInputOpen ? (
              <button onClick={() => setIsGuestsInputOpen(false)} className="bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-zinc-700 ">
                Alterar local/data
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              <button onClick={() => setIsGuestsModalOpen(true)} className="flex items-center gap-2 flex-1 text-left">
